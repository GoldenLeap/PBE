            ...
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg border border-gray-200 dark:border-gray-700">
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    <div class="mb-6">
                        ...
                        <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">Atualizar as informações do produto.</p>
                    </div>
                    ...
                    <form action="{{ route('produtos.update', $produto) }}" method="POST" class="space-y-6">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div class="md:col-span-2">
                                ...
                                <x-text-input id="nome_produto" name="nome_produto" type="text" class="mt-1 block w-full" :value="old('nome_produto', $produto->nome_produto)" required autofocus placeholder="Ex: Camiseta Básica" />
                            ...
                            <div>
                                ...
                                <x-text-input id="preco_produto" name="preco_produto" type="number" step="0.01" min="0" class="mt-1 block w-full" :value="old('preco_produto', $produto->preco_produto)" required placeholder="0,00" />
                            ...
                            <div>
                                ...
                                <x-text-input id="quantidade_produto" name="quantidade_produto" type="number" min="0" class="mt-1 block w-full" :value="old('quantidade_produto', $produto->quantidade_produto)" required placeholder="0" />
