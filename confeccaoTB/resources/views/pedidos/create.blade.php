            ...
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg border border-gray-200 dark:border-gray-700">
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    <div class="mb-6">
                        ...
                        <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">Preencha os dados abaixo para registrar um novo pedido.</p>
                    </div>
                    ...
                    <form action="{{ route('pedidos.store') }}" method="POST" class="space-y-6">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                <x-text-input id="num_pedido" name="num_pedido" type="number" min="1" class="mt-1 block w-full" :value="old('num_pedido')" required autofocus placeholder="Ex: 1001" />
                            ...
                            <div>
                                ...
                                <x-text-input id="nome_cliente" name="nome_cliente" type="text" class="mt-1 block w-full" :value="old('nome_cliente')" required placeholder="Ex: João da Silva" />
