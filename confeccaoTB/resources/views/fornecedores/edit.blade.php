            ...
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg border border-gray-200 dark:border-gray-700">
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    <div class="mb-6">
                        ...
                        <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">Atualize as informações o fornecedor.</p>
                    </div>
                    ...
                    <form action="{{ route('fornecedores.update', $fornecedor) }}" method="POST" class="space-y-6">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div class="md:col-span-2">
                                ...
                                <x-text-input id="nome_fornecedor" name="nome_fornecedor" type="text" class="mt-1 block w-full" :value="old('nome_fornecedor', $fornecedor->nome_fornecedor)" required autofocus placeholder="Ex: Tecidos Brasil Ltda." />
                            ...
                            <div>
                                ...
                                <x-text-input id="cnpj" name="cnpj" type="text" class="mt-1 block w-full bg-gray-100 dark:bg-gray-700 cursor-not-allowed" :value="old('cnpj', $fornecedor->cnpj)" readonly placeholder="00.000.000/0000-00" />
